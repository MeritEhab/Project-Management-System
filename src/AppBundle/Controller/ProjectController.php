...
class ProjectController extends Controller
{
             ...
             if(strtolower(end($chk_ext)) == "csv")
             {
                ...
                while (($data = fgetcsv($handle,1000, ",")) !== FALSE)
                 {  
                    ...
                    $order_obj = $this->createOrders($data, $project_obj);
                    $i++;
                 }
    ...
    public function createOrders($imported_data, $project_obj)
    {
        $order = new Orders();
        if ($imported_data[9] == 'Notice' || $imported_data[9] == 'Lien')
        {
            ...
            {
                $deadline = $this->calculateNoticeOrederDeadline(
            ...
            {
                $deadline = $this->calculateLienOrederDeadline($project_obj->getProjectStartDate());
            }
